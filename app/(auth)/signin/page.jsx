...
function SignInForm() {
  ...
  const [formError, setFormError] = useState(error ? 'Authentication failed. Please try again.' : '')
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.card}>
        ...
        <p className={styles.subtitle}>Sign in to your APIverse account</p>
        ...
        {formError && (
          <div className={styles.errorBanner}>
            ...
            <span>
              {formError}
              {noAccount && (
                <> <Link href="/signup" style={{ color: 'var(--accent-primary)', fontWeight: 600 }}>Create an account →</Link></>
              )}
            </span>
          </div>
        )}
